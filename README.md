...
[![GitHub stars](https://img.shields.io/github/stars/pprgva/grepai?style=flat&logo=github)](https://github.com/pprgva/code-memory/stargazers)
[![Downloads](https://img.shields.io/github/downloads/pprgva/grepai/total?style=flat&logo=github)](https://github.com/pprgva/code-memory/releases)
[![Go](https://github.com/pprgva/code-memory/actions/workflows/ci.yml/badge.svg)](https://github.com/pprgva/code-memory/actions/workflows/ci.yml)
[![Go Report Card](https://goreportcard.com/badge/github.com/pprgva/code-memory)](https://goreportcard.com/report/github.com/pprgva/code-memory)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](LICENSE)

**Search code by meaning, not just text.**

[Documentation](https://pprgva.github.io/grepai/) · [Installation](#installation) · [Quick Start](#quick-start)
...
**Homebrew (macOS):**
```bash
brew install pprgva/tap/grepai
```

**Linux/macOS:**
```bash
curl -sSL https://raw.githubusercontent.com/pprgva/grepai/main/install.sh | sh
```

**Windows (PowerShell):**
```powershell
irm https://raw.githubusercontent.com/pprgva/grepai/main/install.ps1 | iex
```
...
- **[Documentation](https://pprgva.github.io/grepai/)** — Configuration, AI agents, MCP setup
- **[Blog](https://pprgva.github.io/grepai/blog/)** — Benchmarks, tutorials, release notes
...
[MIT License](LICENSE) - Paul P.R. 2026
