...
```markdown
[Unreleased]: https://github.com/pprgva/code-memory/compare/vX.Y.Z...HEAD
[X.Y.Z]: https://github.com/pprgva/code-memory/compare/vPREVIOUS...vX.Y.Z
```
...
```markdown
- **Pascal/Delphi Support**: Add `.pas` and `.dpr` file support (#71) - @pprgva
```
